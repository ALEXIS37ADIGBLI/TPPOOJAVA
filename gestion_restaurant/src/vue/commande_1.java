...
// 6. Style du texte "Total" pour qu'il ressorte (bleu foncé comme la maquette)
     ...
     */
     ...
     // 8. Configurer le modèle du tableau
        javax.swing.table.DefaultTableModel tableModel = new javax.swing.table.DefaultTableModel(
            ...
            public boolean isCellEditable(int row, int column) {
                return false; // Lecture seule, on retire via sélection + bouton
            }
        };
        TableauCommande.setModel(tableModel);

        // 9. Rendre le champ total non éditable
        jTextField1.setEditable(false);
        jTextField1.setText("0.00");

        // 10. Charger les produits dans la ComboBox depuis la BDD
        CommandeController.chargerProduits(ComboBoxProduit);

        // 11. Brancher les boutons
        ...
        // 12. Clic sur une ligne du tableau pour la retirer
        TableauCommande.addMouseListener(new java.awt.event.MouseAdapter() {
            @Override
            public void mouseClicked(java.awt.event.MouseEvent e) {
                int col = TableauCommande.columnAtPoint(e.getPoint());
                // Colonne "Action" (index 4) → retirer la ligne
                if (col == 4) {
